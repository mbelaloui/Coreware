...
/*   Updated: 2018/09/16 11:19:05 by mbelalou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../../inc/asm.h"

static void	put_bin_delim(int i, BOOL with)
{
	int del;
...
static void	put_bin_source_bis1(int i, t_inst *data)
{
	unsigned int	*ret;
	t_charlist		*arg;
	int				size;
...
static void	put_bin_source_bis2(int i, t_inst *data)
{
	unsigned int	*ret;
	t_charlist		*arg;
	int				size;
...
static void	put_bin_data(t_player *player)
{
	t_instlist	*pt;
	int			i;
