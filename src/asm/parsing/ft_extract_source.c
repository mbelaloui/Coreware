...
/*   Updated: 2018/09/27 19:14:11 by mbelalou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_charlist	*get_args(char **str, char *name_op, t_op *op_tab[NBR_OP])
{
	...
	ft_strdel(&args);
/*
 * ft_printf("/ aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa \\ \n");

	ft_putmat(tab_args);
	ft_printf("/ ----------------------------------------------- \\ \n");
*/	ret_args = ft_mat_to_charlist(tab_args);

/*	ft_put_list_charlist(ret_args);
...
/*
	ft_printf("\n/ ************************************************** \\ \n");
			ft_printf(" param inst\n");

	ft_put_list_charlist(inst->param);
	ft_printf("/ ************************************************** \\ \n");
*/
	//		ft_printf("   ");
	//		ft_printf(" inst  ");
